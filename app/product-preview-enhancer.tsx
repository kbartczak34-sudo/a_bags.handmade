        ...
        <div className="abags-preview-layer">
          ...
          <section className="abags-preview-dialog" role="dialog" aria-modal="true" aria-labelledby="abags-preview-title">
            ...
            <div className="abags-preview-copy">
              ...
              <div className="abags-preview-availability"><strong>Wykonywana na zamówienie</strong><span>Dostępność ograniczona — każda sztuka powstaje ręcznie i indywidualnie.</span></div>
              <strong className="abags-preview-price">{product.price}<small>Cena brutto · zawiera VAT 23%</small></strong>
              ...
              <p className="abags-preview-note">Produkt handmade wykonywany na zamówienie · bezpieczna płatność Stripe · wysyłka lub odbiór osobisty</p>
            </div>
          </section>
        </div>
      )}
