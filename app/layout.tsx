...
import BagBuilderPhotorealV17Mount from "./bag-builder-photoreal-v17-mount";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="pl"><body className={`${display.variable} ${sans.variable}`}><PrivacyConsentBanner /><LegalComplianceEnhancer /><PaymentMethodEnhancer /><ProductPreviewEnhancer /><ProductComplianceEnhancer /><VatDisplayEnhancer /><StitchGallery /><StorefrontExperience /><PersonalizationEntry /><ExactLiveCustomizer /><BagBuilderPhotorealV17Mount />{children}<SocialQuickLinks /><AccessibilityClient /></body></html>; }
